...
describe('Type System: Specified scalar types', () => {
  describe('IrisInt', () => {
    it('parseValue', () => {
      ...
      expect(() => parseValue(undefined)).toThrow(
    ...
    it('parseLiteral', () => {
      ...
      expect(() => parseLiteral('1.0')).toThrow(
    ...
    it('serialize', () => {
      ...
      expect(() => serialize(0.1)).toThrow(
        'Int cannot represent non-integer value: 0.1',
      );
      expect(() => serialize(1.1)).toThrow(
      ...
      expect(() => serialize(9876504321)).toThrow(
        'Int cannot represent non 32-bit signed integer value: 9876504321',
      );
      expect(() => serialize(-9876504321)).toThrow(
        'Int cannot represent non 32-bit signed integer value: -9876504321',
  ...
  describe('IrisFloat', () => {
    it('parseValue', () => {
      ...
      expect(() => parseValue('123.5')).toThrow(
      ...
      expect(() => parseValue({ value: 0.1 })).toThrow(
    ...
    it('parseLiteral', () => {
      ...
      expect(() => parseLiteral('"123.5"')).toThrow(
        'Float cannot represent non numeric value: "123.5"',
      );
      expect(() => parseLiteral('false')).toThrow(
        'Float cannot represent non numeric value: false',
      ...
      expect(() => parseLiteral('{ value: 0.1 }')).toThrow(
        'Float cannot represent non numeric value: {value: 0.1}',
      );
      expect(() => parseLiteral('ENUM_VALUE')).toThrow(
  ...
  describe('IrisString', () => {
    ...
    it('parseLiteral', () => {
      ...
      expect(() => parseLiteral('["foo"]')).toThrow(
        'String cannot represent a non string value: ["foo"]',
      );
  ...
  describe('IrisBool', () => {
    ...
    it('serialize', () => {
      ...
      expect(() => serialize([false])).toThrow(
        'Boolean cannot represent a non boolean value: [false]',
      );
      expect(() => serialize({})).toThrow(
        'Boolean cannot represent a non boolean value: {}',
